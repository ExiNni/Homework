...
public class LibraryMenu {
    ...
    private void createMemberAndShowMyPage() {
        ...
        libraryController.insertMember(member);
    ...
    private void showMyPage() {
        Member member = libraryController.myInfo();
        if (member != null) {
    ...
    private void showAllBooks() {
        Book[] books = libraryController.selectAll();
        if (books != null) {
    ...
    public void searchBook() {
        ...
        if (searchList != null && searchList.length > 0) {
            ...
            for (int i = 0; i < searchList.length; i++) {
                ...
                System.out.print(i + "번 도서 : " + book.getTitle() + " / " + book.getAuthor() + " / " + book.getPublisher());
